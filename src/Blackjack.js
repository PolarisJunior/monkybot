...
module.exports = class Blackjack {
  ...
  async maybeInitPlayer(player_id) {
  ...
  playerHandValue(player_id) {
    return getHandValue(this.playerHand(player_id));
  }

  dealerHandValue(player_id) {
    return getHandValue(this.dealerHand(player_id));
  }
  ...
  placeBid(player_id, amt) {
    ...
    if (amt > this.getMoney(player_id) || amt == NaN) {
  ...
  applyWin(player_id, blackjack = false) {
    ...
    this.setMoney(
      player_id,
      this.getMoney(player_id) + multiplier * this.getBid(player_id)
    );
    this.endGame(player_id);
  }
